...
def parse_args():
    ...
    parser.add_argument('--dataset', default = 'Sport', type = str,
                        help = 'Dataset to use')
    parser.add_argument('--seed', default = 2034, type = int,
    ...
    parser.add_argument('--k_list', default = [20,50], type = list,
    ...
    parser.add_argument('--metrics', default = ['precision', 'recall', 'hit_ratio', 'coverage','ndcg'])
    ...
    parser.add_argument('--input_dim', type=int, default=32, help='Dimension of input features')
    parser.add_argument('--output_dim', type=int, default=32, help='Dimension of output features')
    parser.add_argument('--num_heads', type=int, default=5, help='Number of heads in multi-head attention')
